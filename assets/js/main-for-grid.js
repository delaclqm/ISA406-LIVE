    ...
    export class Details {
        constructor(parentDOM) {
            ...
            const detailsTmpl = `
            <div class="details__bg details__bg--up black"></div>
            <div class="details__bg details__bg--down accent"></div>
            ...
            parentDOM.appendChild(this.DOM.details);
            this.init();
        }
        init() {
    ...
    export class Item {
        ...
        open() {
            this.parentDetails.fill(this.info);
            this.parentDetails.open({
